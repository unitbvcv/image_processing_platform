...
class PlotterWindow(QtWidgets.QMainWindow):
    ...
    def _setupUi(self):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonAutoScale.sizePolicy().hasHeightForWidth())
        self.pushButtonAutoScale.setSizePolicy(sizePolicy)
        self.pushButtonAutoScale.setObjectName("pushButtonAutoScale")
        self.verticalLayout_5.addWidget(self.pushButtonAutoScale)
        self.verticalLayoutSettings.addWidget(self.groupBoxSettings)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayoutSettings.addItem(spacerItem1)
    ...
    def _retranslateUi(self):
        ...
        self.pushButtonAutoScale.setText(_translate("PlotterWindow", "Rescale plots"))
